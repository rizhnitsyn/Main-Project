    ...
    public Tournament getTournamentById(Long tournamentId) {
        try (Connection connection = ConnectionManager.newConnection()){
            ...
            if (resultSet.next()) {
                ...
                tournament.addFootballMatch(new FootballMatch(resultSet.getLong("b.match_id"), resultSet.getInt("b.first_team_result"),
                ...
                while (resultSet.next()) {
                    tournament.addFootballMatch(new FootballMatch(resultSet.getLong("b.match_id"),
